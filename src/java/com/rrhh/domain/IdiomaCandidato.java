...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "IdiomaCandidato.findAll", query = "SELECT i FROM IdiomaCandidato i")
    , @NamedQuery(name = "IdiomaCandidato.findById", query = "SELECT i FROM IdiomaCandidato i WHERE i.id = :id")})
public class IdiomaCandidato implements Serializable {
    ...
    public IdiomaCandidato(Integer id) {
        this.id = id;
    }
